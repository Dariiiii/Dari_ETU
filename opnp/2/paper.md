...
Направление дальнейших иследований включает реализацию описанной подсистемы, внедрение подсистемы в систему интеллектуального анализа студенческих работ, поиск подходящих пороговых значений для числовых характеристик и формирование множества редких символов.
